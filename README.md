...
_Auto-generated from curated `datasets/` on 2026-08-30T18:05:36Z. Sandbox drafts are excluded._
...
| AI agents | 4 |
| Human-only accessions | 1,003 |
| Agent-assisted accessions | 5,746 |
...
**Highlights:** most common organism is **Homo sapiens**; **51,395** DIA assay rows; **61,687** TMT and **220,748** LFQ assay rows; **67** single-cell, **192** cell-line, and **117** metaproteomics accessions; sample-field completeness (applicable samples): disease 33%, age 11%; **5,746** accessions are agent-assisted (mostly **Cursor**); **8** accessions have Codex evidence (`codex/` PR branches); most common instrument is **Q Exactive**; most common modification is **Carbamidomethyl**; **12.1%** of public ProteomeXchange datasets have a curated SDRF here; **16.2%** of PRIDE projects are annotated.
