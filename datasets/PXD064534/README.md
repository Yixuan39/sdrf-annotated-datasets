# PXD064534 — adult mouse 10-region brain circadian proteome (DIA)

[PXD064534](https://www.ebi.ac.uk/pride/archive/projects/PXD064534): part of *Mouse Circadian
Proteome Atlas by next-generation deep proteome analysis* (Yoshitane lab; released
2025-11-27). Deep label-free **DIA** on an **Orbitrap Astral** of ten brain regions in
...
| Tissues (10) | hypothalamus (HYP), olfactory bulb (OB), prefrontal cortex (PFC), striatum (STR), midbrain (MB), thalamic complex (TH), cerebellum (CEL), hindbrain (HB), cerebral cortex (CTXR), hippocampal formation (HPCR) |
...
parse_sdrf validate-sdrf \
  -s datasets/PXD064534/PXD064534.sdrf.tsv \
