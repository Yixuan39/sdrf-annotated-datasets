# PXD064539 — adult mouse digestive/adipose 10-tissue circadian proteome (DIA)

[PXD064539](https://www.ebi.ac.uk/pride/archive/projects/PXD064539): part of *Mouse Circadian
Proteome Atlas by next-generation deep proteome analysis* (Yoshitane lab; released
2025-11-27). Deep label-free **DIA** on an **Orbitrap Astral** of ten digestive, adipose and reproductive tissues in
...
| Tissues (10) | esophagus, stomach, duodenum, small intestine, caecum, colon, testis, epididymal fat pad (eWAT), inguinal fat pad (iWAT), brown adipose tissue (BAT) |
...
The panel includes male-specific tissues (**testis** and **epididymal fat pad**), which implies a male cohort; `characteristics[sex]` is still left `not available` pending manuscript confirmation for the non-sex-specific tissues.
...
parse_sdrf validate-sdrf \
  -s datasets/PXD064539/PXD064539.sdrf.tsv \
